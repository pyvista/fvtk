...
def calldata_type(type):
    ...
    import cvista.util.calldata_type
    import cvista.util.vtkConstants
    import cvista.vtkCommonCore import vtkCommand, vtkLookupTable
    ...
    """
    from cvista import vtkCommonCore
...
def vtkRegressionTestImage(renWin):
    ...
    from cvista.vtkIOImage import vtkPNGReader
    from cvista.vtkImagingCore import vtkImageDifference
