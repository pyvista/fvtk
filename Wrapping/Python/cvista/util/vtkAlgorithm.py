from cvista.vtkCommonCore import vtkInformation
from cvista.vtkCommonDataModel import vtkDataObject
from cvista.vtkCommonExecutionModel import vtkAlgorithm
from cvista.vtkCommonExecutionModel import vtkDemandDrivenPipeline
from cvista.vtkCommonExecutionModel import vtkStreamingDemandDrivenPipeline
from cvista.vtkFiltersPython import vtkPythonAlgorithm
...
class VTKPythonAlgorithmBase(vtkPythonAlgorithm):
    ...
    class HDF5Source(VTKPythonAlgorithmBase):
        ...
        def RequestInformation(self, request, inInfo, outInfo):
            ...
            info.Set(cvista.vtkCommonExecutionModel.vtkStreamingDemandDrivenPipeline.WHOLE_EXTENT(),
        ...
        def RequestData(self, request, inInfo, outInfo):
            f = h5py.File("foo.h5", 'r')
            data = f['RTData'][:]
            output = dsa.WrapDataObject(cvista.vtkCommonDataModel.vtkImageData.GetData(outInfo))
    ...
    cf = cvista.vtkFiltersCore.vtkContourFilter()
