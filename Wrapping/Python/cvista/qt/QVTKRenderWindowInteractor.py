...
try:
    import cvista.qt
    QVTKRWIBase = cvista.qt.QVTKRWIBase
except ImportError:
    pass

from cvista.vtkRenderingCore import vtkRenderWindow
from cvista.vtkRenderingUI import vtkGenericRenderWindowInteractor
...
def QVTKRenderWidgetConeExample():
    ...
    from cvista.vtkRenderingCore import vtkActor, vtkPolyDataMapper, vtkRenderer
