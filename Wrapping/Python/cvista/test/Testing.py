...
from cvista.vtkCommonCore import vtkCommand, vtkDebugLeaks, reference
from cvista.vtkCommonSystem import vtkTimerLog
from cvista.vtkIOImage import vtkPNGWriter
from cvista.vtkRenderingCore import vtkWindowToImageFilter
from cvista.vtkTestingRendering import vtkTesting
...
def _GetController():
    try:
        from cvista.vtkParallelMPI import vtkMPIController
...
if __name__ == "__main__":
    ...
    class SampleTest(vtkTest):
        from cvista.vtkRenderingCore import vtkActor
        obj = vtkActor()
        def testParse(self):
