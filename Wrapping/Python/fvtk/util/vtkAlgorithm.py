from fvtk.vtkCommonCore import vtkInformation
from fvtk.vtkCommonDataModel import vtkDataObject
from fvtk.vtkCommonExecutionModel import vtkAlgorithm
from fvtk.vtkCommonExecutionModel import vtkDemandDrivenPipeline
from fvtk.vtkCommonExecutionModel import vtkStreamingDemandDrivenPipeline
from fvtk.vtkFiltersPython import vtkPythonAlgorithm
...
class VTKPythonAlgorithmBase(vtkPythonAlgorithm):
    ...
    class HDF5Source(VTKPythonAlgorithmBase):
        ...
        def RequestInformation(self, request, inInfo, outInfo):
            ...
            info.Set(fvtk.vtkCommonExecutionModel.vtkStreamingDemandDrivenPipeline.WHOLE_EXTENT(),
        ...
        def RequestData(self, request, inInfo, outInfo):
            f = h5py.File("foo.h5", 'r')
            data = f['RTData'][:]
            output = dsa.WrapDataObject(fvtk.vtkCommonDataModel.vtkImageData.GetData(outInfo))
    ...
    cf = fvtk.vtkFiltersCore.vtkContourFilter()
