...
from fvtk.vtkCommonCore import vtkPoints, vtkAbstractArray, vtkDataArray
from fvtk.vtkCommonDataModel import (
    vtkCellArray,
    vtkDataObject,
    vtkFieldData,
...
with suppress(ImportError):
    import numpy
    from fvtk.numpy_interface import dataset_adapter as dsa
...
class DataSet(object):
    ...
    def convert_to_unstructured_grid(self):
        from fvtk.vtkFiltersCore import vtkExtractCells
...
with suppress(ImportError):
    import copyreg
    from fvtk.util.pickle_support import serialize_VTK_data_object
