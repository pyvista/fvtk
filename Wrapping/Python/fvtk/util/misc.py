...
def calldata_type(type):
    ...
    import fvtk.util.calldata_type
    import fvtk.util.vtkConstants
    import fvtk.vtkCommonCore import vtkCommand, vtkLookupTable
    ...
    """
    from fvtk import vtkCommonCore
...
def vtkRegressionTestImage(renWin):
    ...
    from fvtk.vtkIOImage import vtkPNGReader
    from fvtk.vtkImagingCore import vtkImageDifference
