...
from fvtk.vtkCommonCore import vtkCommand, vtkDebugLeaks, reference
from fvtk.vtkCommonSystem import vtkTimerLog
from fvtk.vtkIOImage import vtkPNGWriter
from fvtk.vtkRenderingCore import vtkWindowToImageFilter
from fvtk.vtkTestingRendering import vtkTesting
...
def _GetController():
    try:
        from fvtk.vtkParallelMPI import vtkMPIController
