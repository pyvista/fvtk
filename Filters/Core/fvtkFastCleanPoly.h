...
// fvtk opt-in fast coincident-point merge for polygonal data.
//
...
#ifndef fvtkFastCleanPoly_h
#define fvtkFastCleanPoly_h
 ...
 * fvtk.EnableFast()) AND the request is the exact-merge default regime restricted
...
#endif
// VTK-HeaderTest-Exclude: fvtkFastCleanPoly.h
