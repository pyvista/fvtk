...
// cvista opt-in fast connected-components labeling: parallel union-find over cells
...
// isolated, mirroring cvistaFastClean.
#include "cvistaFastConnectivity.h"
...
#else // !CVISTA_HAVE_OPENMP -- bit-exact stub, caller runs the stock wave-BFS.
